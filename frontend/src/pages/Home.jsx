...
synth.speak(utterence);
  ...
  const handleCommand=(data)=>{
    ...
    if (!data || data.type === "error") {
      speak(data?.response || "Sorry, I encountered an error.");
      return;
    }
    ...
    if (type === 'website-open') {
      ...
      if (query.includes('.com')) {
        window.open(`https://www.${query}`, '_blank');
      } else {
        window.open(`https://www.${query}.com`, '_blank');
      }
    }
...
useEffect(() => {
  ...
  recognition.onerror = (event) => {
    ...
    // Don't restart on network error - it's usually HTTPS related
    if (event.error === "network") {
      console.log("Network error - speech recognition requires HTTPS or localhost");
      // Show user a message about the issue
      setAiText("Microphone access issue. Please use HTTPS or check microphone permissions.");
      return;
    }
  ...
  recognition.onresult = async (e) => {
    ...
    console.log("Includes assistant name:", transcript.toLowerCase().includes(userData.assistantName.toLowerCase()));
    ...
    if (transcript.toLowerCase().includes(userData.assistantName.toLowerCase())) {
      ...
      try {
        ...
        if (data && data.response) {
          ...
          setAiText("Sorry, I didn't understand that.");
        }
      } catch (error) {

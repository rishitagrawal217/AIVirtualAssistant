...
import ruleBasedResponse from "../ruleBased.js"
...
export const askToAssistant = async (req, res) => {
  try {
    ...
    // If OpenAI fails, use rule-based response
    if (!result) {
      console.log("OpenAI failed, using rule-based response");
      finalResult = ruleBasedResponse(command, assistantName, userName);
    } else {
      finalResult = result;
    }
    ...
    // Handle API errors
    if (!finalResult) {
      console.log("All AI methods failed");
